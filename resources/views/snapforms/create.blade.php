...
<div class="flex-center position-ref full-height">
    ...
    <div class="content">
        ...
        <form method="POST" action="{{ route('form.store') }}" class="space-y-8 divide-y divide-gray-200">
                ...
                <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                    <div class="space-y-6 sm:space-y-5">
                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <input type="text" name="address" id="address" autocomplete="address" class="block max-w-lg w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <input type="text" name="suburb" id="suburb" autocomplete="address-level2" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <input type="text" name="postcode" id="postcode" autocomplete="postcode" class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                    </div>
                </div>
